...
export function decodePracticeSettings(
  ...
  return compact<PracticeSettings>({
    ...
    rushingCounts: readBoolean(value['rushingCounts']),
    markWhileListening: readBoolean(value['markWhileListening']),
    showPlaybackNotes: readBoolean(value['showPlaybackNotes']),
    rollScrollPlayback: readBoolean(value['rollScrollPlayback']),
    rollHeadAtPercent: readInteger(value['rollHeadAtPercent'], 0, 50),
...
export function encodePracticeSettings(settings: PracticeSettings): Record<string, unknown> {
  return {
    ...
    hearTheOtherHand: settings.hearTheOtherHand,
    showRepeatNumbers: settings.showRepeatNumbers,
    rushingCounts: settings.rushingCounts,
    markWhileListening: settings.markWhileListening,
    showPlaybackNotes: settings.showPlaybackNotes,
    rollScrollPlayback: settings.rollScrollPlayback,
    rollHeadAtPercent: settings.rollHeadAtPercent,
